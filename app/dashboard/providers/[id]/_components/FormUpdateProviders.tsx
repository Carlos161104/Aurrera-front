...
import DeleteProvider from "./DelteProvider";
  ...
  return (
    <>
      <form
        ...
        className="flex flex-wrap gap-4 flex-grow-0 bg-green-200 rounded-md px-10 py-10 mr-20 items-center justify-center"
      >
        <Input
